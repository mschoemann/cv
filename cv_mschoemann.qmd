...
\vspace{-5pt}
{\large\Telefon} +49 (351) 463-37899\par
\vspace{-5pt}
...
2026 -- present & \textbf{TUD Dresden University of Technology}, Dresden, Germany \\
 & Research Associate (faculty), Psychological Research Methods and Cognitive Modelling\\
 & \emph{Permanent faculty position (equivalent to tenured)}\\[5pt]

2022 -- 2026 & \textbf{TUD Dresden University of Technology}, Dresden, Germany \\
 & Research Associate (postdoc), Psychological Research Methods and Cognitive Modelling\\[5pt]

2020 -- 2022 & \textbf{Aarhus University}, Aarhus, Denmark \\
 & Research Assistant (predoc), Management\\[5pt]
...
df |> 
  ...
  footnote(
      general_title = "",
      general = paste0(
      "F = Fall, denotes the winter term, Oct.--Mar.; ",
      "S = Spring, denotes the summer term, Apr.--Sep."
    ),
    symbol = paste0(
      "Faculty Course Evaluations (FCE) for ``Overall satisfaction'' scored ",
      "1--5 (1 = best). Department mean of similar courses in parentheses. ",
      "Evaluations are reported NA if too few responses were collected. ",
      "Complete evaluation sheets (in German) are available upon request."
    ),
    threeparttable = TRUE
)
```
